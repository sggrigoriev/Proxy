...
//  max_conns_amount - max amount of simultaneous hppt(s) connections
...
//  conn_type   - created connection type.
//  url         - url string
//  auth_token  - the gateway auth token for authorization on cloud side
//  deviceID    - the gateway device id
//  conn_to     - connection timeout in seconds
...
//  get_conn    - connection handler LIB_HTTP_CONN_GET or LIB_HTTP_CONN_INIT_MAIN type
...
//  msg         - char string to send
//  reply       - buffer for possible reply
...
//Reag file
//  gf_conn     - connection handler LIB_HTTP_FILE_GET type
//  rx_file     - open file descriptor ("wb" mode expected)
